    ...
    module Api
      module Permissions
        ...
        def enforce_permission_to(action, subject, extra_context = {})
          raise Decidim::BudgetingPipeline::ActionForbidden unless allowed_to?(action, subject, extra_context)
        end
        ...
        class ::Decidim::BudgetingPipeline::ActionForbidden < StandardError
        end
      end
    end
  end
